...
CharCode charCodes[256] = {
  ...
  CHAR_SPACE, CHAR_EXCLAIMATION, CHAR_UNKNOWN, CHAR_UNKNOWN, CHAR_UNKNOWN, CHAR_MODULE, CHAR_UNKNOWN, CHAR_SINGLEQUOTE,
  ...
  CHAR_DIGIT, CHAR_DIGIT, CHAR_COLON, CHAR_SEMICOLON, CHAR_LT, CHAR_EQ, CHAR_GT, CHAR_QUESTION,
